...
## 本项目获取地址：https://www.bishecode.com/product/178/
...
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图展示的就是管理员功能结构图，管理员在后台主要管理收货地址管理、购物车管理、字典管理、图书管理、图书收藏管理、图书评价管理、图书订单管理、用户管理、管理员管理等。

![alt text](images/image-1.png)

# 五、效果图展示【部分效果图】

图5.1 图书列表页面【如图5.1显示的就是图书列表页面，此页面提供给管理员的功能有：查看图书、新增图书、修改图书、删除图书等。】
![alt text](images/image-2.png)

图5.2 图书信息管理页面【图书订单信息管理页面提供的功能操作有：发货，删除图书订单操作。下图就是图书订单信息管理页面。】
![alt text](images/image-3.png)

图5.3 图书类型列表页面【图书类型管理页面显示所有图书类型，在此页面既可以让管理员添加新的图书信息类型，也能对已有的图书类型信息执行编辑更新，失效的图书类型信息也能让管理员快速删除。下图就是图书类型管理页面。】
